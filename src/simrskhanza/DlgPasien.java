...
public class DlgPasien extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnViaDukcapilNikBatam.setBackground(new java.awt.Color(255, 255, 254));
        MnViaDukcapilNikBatam.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnViaDukcapilNikBatam.setForeground(new java.awt.Color(70, 70, 70));
        ...
        DTPLahir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "06-10-2019" }));
        ...
        DTPDaftar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "06-10-2019" }));
...
private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        if(TNo.getText().trim().equals("")){
            ...
            try {
                //ps=koneksi.prepareStatement("select no_rkm_medis from set_no_rkm_medis ");
                //rs=ps.executeQuery();
                int norm;
                int norm1;
                String norm_string;
                ...
                norm1=norm+1;
               // jTextField1.setText(String.valueOf(norm1).toString());
                norm_string=String.valueOf(norm1).toString();
            ...
            if(Sequel.menyimpantf2("pasien","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rekam Medis Pasien",36,new String[]{
                ...
                if(Sequel.menyimpantf2("pasien","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rekam Medis Pasien",36,new String[]{
                        //TNo.getText(),
                        norm_string.toString(),TNm.getText(),TKtp.getText(),CmbJk.getSelectedItem().toString().substring(0,1),TTmp.getText(),
                        Valid.SetTgl(DTPLahir.getSelectedItem()+""),NmIbu.getText(),
                        Alamat.getText().replaceAll("ALAMAT",""),CMbGd.getSelectedItem().toString(),Pekerjaan.getText(),CmbStts.getSelectedItem().toString(),cmbAgama.getSelectedItem().toString(),
                        DTPDaftar.getSelectedItem().toString().substring(6,10)+"-"+DTPDaftar.getSelectedItem().toString().substring(3,5)+"-"+DTPDaftar.getSelectedItem().toString().substring(0,2),
                        TTlp.getText(),TUmurTh.getText()+" Th "+TUmurBl.getText()+" Bl "+TUmurHr.getText()+" Hr",CMbPnd.getSelectedItem().toString(),klg,Saudara.getText(),Kdpnj.getText(),TNoPeserta.getText(),
