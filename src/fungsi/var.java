...
public final class var {
    ...
    private static boolean admin=false,user=false,vakum=false,aplikasi=false,penyakit=false,obat_penyakit=false,dokter=false,jadwal_praktek=false,petugas=false,pasien=false,registrasi=false,
            ...
            inventaris_koleksi=false,inventaris_inventaris=false,inventaris_sirkulasi=false,informasi_kamar=false,harian_tindakan_poli=false,obat_per_poli=false,obat_per_kamar=false,
            ...
            billing_ralan=false,billing_ranap=false,status=false,jm_ranap_dokter=false,igd=false,set_harga_obat_ralan=false,
            set_harga_obat_ranap=false,diagnosa_pasien=false,kunjungan_ralan=false,harian_tindakan_dokter=false,
            sidikjari=false,jam_masuk=false,jadwal_pegawai=false,set_nota=false,dpjp_ranap=false,mutasi_barang=false,
            ...
            harian_paket_bhp=false,bulanan_paket_bhp=false,piutang_pasien2=false,bpjs_referensi_faskes=false,bpjs_sep=false,
            suplier_penunjang=false,bpjs_monitoring_klaim=false,harian_kamar=false,rincian_piutang_pasien=false,keuntungan_beri_obat_nonpiutang=false,
            hutang_obat=false,riwayat_obat_alkes_bhp=false,sensus_harian_poli=false,referensi_mobilejkn_bpjs=false,batal_pendaftaran_mobilejkn_bpjs=false, 
            aplicare_referensi_kamar=false,aplicare_ketersediaan_kamar=false,akun_piutang=false,harian_kso=false,bulanan_kso=false,harian_menejemen=false,bulanan_menejemen=false;
       ...
       try {
                ...
                try {
                    ...
                    if(rs.getRow()>=1){
                        ...
                        var.referensi_mobilejkn_bpjs=true;
                        var.batal_pendaftaran_mobilejkn_bpjs=true;                        
                        ...
                        var.referensi_mobilejkn_bpjs=rs2.getBoolean("referensi_mobilejkn_bpjs");
                        var.batal_pendaftaran_mobilejkn_bpjs=rs2.getBoolean("batal_pendaftaran_mobilejkn_bpjs");
                        ...
                        var.referensi_mobilejkn_bpjs=false;
                        var.batal_pendaftaran_mobilejkn_bpjs=false;
    ...
    public static boolean getreferensi_mobilejkn_bpjs(){return var.referensi_mobilejkn_bpjs;}
    public static boolean getbatal_pendaftaran_mobilejkn_bpjs(){return var.batal_pendaftaran_mobilejkn_bpjs;}
