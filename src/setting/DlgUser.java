...
public class DlgUser extends javax.swing.JDialog {
    ...
    public DlgUser(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={
            ...
            "[A]Diet Pasien",
            "[L]Kelahiran Bayi",
            "[A]Periksa Lab","[A]Periksa Radiologi","[A]Kasir Ralan",
                    "[J]Deposit Pasien","[J]Piutang Pasien","[C]Barcode Presensi","[C]Presensi Harian","[C]Presensi Bulanan",
                    ...
                    "[E]Rekap Pengadaan Non Medis","[E]Rekap Stok Keluar Non Medis","[E]Biaya Pengadaan Non Medis","[A]Informasi Kamar","[H]Harian Dokter Poli","[H]Obat Per Poli","[H]Obat Per Kamar",
                    ...
                    "[N]Biaya Masuk Sekali","[N]Set RM","[A]Billing Ralan","[A]Billing Ranap","[H]Detail JM Dokter","[A]IGD",
                    "[N]Set Harga Obat Ralan","[N]Set Harga Obat Ranap","[I]Surveilans Ralan","[L]Diagnosa Pasien",
                    "[I]Kunjungan Ralan","[H]Harian Dokter Ralan","[C]Sidik Jari","[C]Jam Presensi","[C]Jadwal Pegawai","[N]Set Billing","[A]DPJP Ranap","[D]Mutasi Obat/Alkes/BHP",
                    ...
                    "[K]Data Bridging SEP BPJS","[M]Pengambilan BHP Medis","[M]BHP Medis Rusak","[M]Pengambilan BHP Non Medis",
                    "[M]BHP Non Medis Rusak","[E]Suplier Non Medis","[K]Monitoring Verifikasi Klaim",
                    "[H]Harian Kamar","[J]Rincian Piutang Pasien","[D]Keuntungan Beri Obat, Alkes & BHP 2",
                    "[J]Hutang Obat & BHP","[D]Riwayat Obat, Alkes & BHP","[I]Sensus Harian Poli","[K]Referensi Kamar Aplicare","[K]Ketersediaan Kamar Aplicare",
                    "[J]Akun Piutang","[H]Harian KSO","[H]Bulanan KSO",
        ...
        if(TKd.getText().trim().equals("")||TNmUser.getText().trim().equals("")){
            ...
            if(i!= -1){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+tbUser.getValueAt(i,0).toString()+"','nur')",
                    ...
                    "barcode='"+tbUser.getValueAt(i,26).toString()+"',"+
                    "presensi_harian='"+tbUser.getValueAt(i,27).toString()+"',"+
                    "presensi_bulanan='"+tbUser.getValueAt(i,28).toString()+"',"+
                    "pegawai_admin='"+tbUser.getValueAt(i,29).toString()+"',"+
                    "pegawai_user='"+tbUser.getValueAt(i,30).toString()+"',"+
                    "suplier='"+tbUser.getValueAt(i,31).toString()+"',"+
                    "satuan_barang='"+tbUser.getValueAt(i,32).toString()+"',"+
                    "konversi_satuan='"+tbUser.getValueAt(i,33).toString()+"',"+
                    "jenis_barang='"+tbUser.getValueAt(i,34).toString()+"',"+
                    "obat='"+tbUser.getValueAt(i,35).toString()+"',"+
                    "stok_opname_obat='"+tbUser.getValueAt(i,36).toString()+"',"+
                    "stok_obat_pasien='"+tbUser.getValueAt(i,37).toString()+"',"+
                    "pengadaan_obat='"+tbUser.getValueAt(i,38).toString()+"',"+
                    "pemesanan_obat='"+tbUser.getValueAt(i,39).toString()+"',"+
                    "penjualan_obat='"+tbUser.getValueAt(i,40).toString()+"',"+
                    "piutang_obat='"+tbUser.getValueAt(i,41).toString()+"',"+
                    "retur_ke_suplier='"+tbUser.getValueAt(i,42).toString()+"',"+
                    "retur_dari_pembeli='"+tbUser.getValueAt(i,43).toString()+"',"+
                    "retur_obat_ranap='"+tbUser.getValueAt(i,44).toString()+"',"+
                    "retur_piutang_pasien='"+tbUser.getValueAt(i,45).toString()+"',"+
                    "keuntungan_penjualan='"+tbUser.getValueAt(i,46).toString()+"',"+
                    "keuntungan_beri_obat='"+tbUser.getValueAt(i,47).toString()+"',"+
                    "sirkulasi_obat='"+tbUser.getValueAt(i,48).toString()+"',"+
                    "ipsrs_barang='"+tbUser.getValueAt(i,49).toString()+"',"+
                    "ipsrs_pengadaan_barang='"+tbUser.getValueAt(i,50).toString()+"',"+
                    "ipsrs_stok_keluar='"+tbUser.getValueAt(i,51).toString()+"',"+
                    "ipsrs_rekap_pengadaan='"+tbUser.getValueAt(i,52).toString()+"',"+
                    "ipsrs_rekap_stok_keluar='"+tbUser.getValueAt(i,53).toString()+"',"+
                    "ipsrs_pengeluaran_harian='"+tbUser.getValueAt(i,54).toString()+"',"+
                    "informasi_kamar='"+tbUser.getValueAt(i,55).toString()+"',"+
                    "harian_tindakan_poli='"+tbUser.getValueAt(i,56).toString()+"',"+
                    "obat_per_poli='"+tbUser.getValueAt(i,57).toString()+"',"+
                    "obat_per_kamar='"+tbUser.getValueAt(i,58).toString()+"',"+
                    "obat_per_dokter_ralan='"+tbUser.getValueAt(i,59).toString()+"',"+
                    "obat_per_dokter_ranap='"+tbUser.getValueAt(i,60).toString()+"',"+
                    "harian_dokter='"+tbUser.getValueAt(i,61).toString()+"',"+
                    "bulanan_dokter='"+tbUser.getValueAt(i,62).toString()+"',"+
                    "harian_paramedis='"+tbUser.getValueAt(i,63).toString()+"',"+
                    "bulanan_paramedis='"+tbUser.getValueAt(i,64).toString()+"',"+
                    "pembayaran_ralan='"+tbUser.getValueAt(i,65).toString()+"',"+
                    "pembayaran_ranap='"+tbUser.getValueAt(i,66).toString()+"',"+
                    "rekap_pembayaran_ralan='"+tbUser.getValueAt(i,67).toString()+"',"+
                    "rekap_pembayaran_ranap='"+tbUser.getValueAt(i,68).toString()+"',"+
                    "tagihan_masuk='"+tbUser.getValueAt(i,69).toString()+"',"+
                    "tambahan_biaya='"+tbUser.getValueAt(i,70).toString()+"',"+
                    "potongan_biaya='"+tbUser.getValueAt(i,71).toString()+"',"+
                    "resep_obat='"+tbUser.getValueAt(i,72).toString()+"',"+
                    "resume_pasien='"+tbUser.getValueAt(i,73).toString()+"',"+
                    "penyakit_ralan='"+tbUser.getValueAt(i,74).toString()+"',"+
                    "penyakit_ranap='"+tbUser.getValueAt(i,75).toString()+"',"+
                    "kamar='"+tbUser.getValueAt(i,76).toString()+"',"+
                    "tarif_ralan='"+tbUser.getValueAt(i,77).toString()+"',"+
                    "tarif_ranap='"+tbUser.getValueAt(i,78).toString()+"',"+
                    "tarif_lab='"+tbUser.getValueAt(i,79).toString()+"',"+
                    "tarif_radiologi='"+tbUser.getValueAt(i,80).toString()+"',"+
                    "tarif_operasi='"+tbUser.getValueAt(i,81).toString()+"',"+
                    "akun_rekening='"+tbUser.getValueAt(i,82).toString()+"',"+
                    "rekening_tahun='"+tbUser.getValueAt(i,83).toString()+"',"+
                    "posting_jurnal='"+tbUser.getValueAt(i,84).toString()+"',"+
                    "buku_besar='"+tbUser.getValueAt(i,85).toString()+"',"+
                    "cashflow='"+tbUser.getValueAt(i,86).toString()+"',"+
                    "keuangan='"+tbUser.getValueAt(i,87).toString()+"',"+
                    "pengeluaran='"+tbUser.getValueAt(i,88).toString()+"',"+
                    "setup_pjlab='"+tbUser.getValueAt(i,89).toString()+"',"+
                    "setup_otolokasi='"+tbUser.getValueAt(i,90).toString()+"',"+
                    "setup_jam_kamin='"+tbUser.getValueAt(i,91).toString()+"',"+
                    "setup_embalase='"+tbUser.getValueAt(i,92).toString()+"',"+
                    "tracer_login='"+tbUser.getValueAt(i,93).toString()+"',"+
                    "display='"+tbUser.getValueAt(i,94).toString()+"',"+
                    "set_harga_obat='"+tbUser.getValueAt(i,95).toString()+"',"+
                    "set_penggunaan_tarif='"+tbUser.getValueAt(i,96).toString()+"',"+
                    "set_oto_ralan='"+tbUser.getValueAt(i,97).toString()+"',"+
                    "biaya_harian='"+tbUser.getValueAt(i,98).toString()+"',"+
                    "biaya_masuk_sekali='"+tbUser.getValueAt(i,99).toString()+"',"+
                    "set_no_rm='"+tbUser.getValueAt(i,100).toString()+"',"+
                    "billing_ralan='"+tbUser.getValueAt(i,101).toString()+"',"+
                    "billing_ranap='"+tbUser.getValueAt(i,102).toString()+"',"+
                    "jm_ranap_dokter='"+tbUser.getValueAt(i,103).toString()+"',"+
                    "igd='"+tbUser.getValueAt(i,104).toString()+"',"+
                    "set_harga_obat_ralan='"+tbUser.getValueAt(i,105).toString()+"',"+
                    "set_harga_obat_ranap='"+tbUser.getValueAt(i,106).toString()+"',"+
                    "diagnosa_pasien='"+tbUser.getValueAt(i,107).toString()+"',"+
                    "kunjungan_ralan='"+tbUser.getValueAt(i,108).toString()+"',"+
                    "harian_tindakan_dokter='"+tbUser.getValueAt(i,109).toString()+"',"+
                    "sidikjari='"+tbUser.getValueAt(i,110).toString()+"',"+
                    "jam_masuk='"+tbUser.getValueAt(i,111).toString()+"',"+
                    "jadwal_pegawai='"+tbUser.getValueAt(i,112).toString()+"',"+
                    "set_nota='"+tbUser.getValueAt(i,113).toString()+"',"+
                    "dpjp_ranap='"+tbUser.getValueAt(i,114).toString()+"',"+
                    "mutasi_barang='"+tbUser.getValueAt(i,115).toString()+"',"+
                    "fee_visit_dokter='"+tbUser.getValueAt(i,116).toString()+"',"+
                    "fee_bacaan_ekg='"+tbUser.getValueAt(i,117).toString()+"',"+
                    "fee_rujukan_rontgen='"+tbUser.getValueAt(i,118).toString()+"',"+
                    "fee_rujukan_ranap='"+tbUser.getValueAt(i,119).toString()+"',"+
                    "fee_ralan='"+tbUser.getValueAt(i,120).toString()+"',"+
                    "akun_bayar='"+tbUser.getValueAt(i,121).toString()+"',"+
                    "bayar_pemesanan_obat='"+tbUser.getValueAt(i,122).toString()+"',"+
                    "obat_per_dokter_peresep='"+tbUser.getValueAt(i,123).toString()+"',"+
                    "ipsrs_jenis_barang='"+tbUser.getValueAt(i,124).toString()+"',"+
                    "pemasukan_lain='"+tbUser.getValueAt(i,125).toString()+"',"+
                    "pengaturan_rekening='"+tbUser.getValueAt(i,126).toString()+"',"+
                    "closing_kasir='"+tbUser.getValueAt(i,127).toString()+"',"+
                    "keterlambatan_presensi='"+tbUser.getValueAt(i,128).toString()+"',"+
                    "set_harga_kamar='"+tbUser.getValueAt(i,129).toString()+"',"+
                    "rekap_per_shift='"+tbUser.getValueAt(i,130).toString()+"',"+
                    "bpjs_cek_nik='"+tbUser.getValueAt(i,131).toString()+"',"+
                    "bpjs_cek_kartu='"+tbUser.getValueAt(i,132).toString()+"',"+
                    "bpjs_cek_riwayat='"+tbUser.getValueAt(i,133).toString()+"',"+
                    "obat_per_cara_bayar='"+tbUser.getValueAt(i,134).toString()+"',"+
                    "kunjungan_ranap='"+tbUser.getValueAt(i,135).toString()+"',"+
                    "bayar_piutang='"+tbUser.getValueAt(i,136).toString()+"',"+
                    "payment_point='"+tbUser.getValueAt(i,137).toString()+"',"+
                    "bpjs_cek_nomor_rujukan='"+tbUser.getValueAt(i,138).toString()+"',"+
                    "icd9='"+tbUser.getValueAt(i,139).toString()+"',"+
                    "darurat_stok='"+tbUser.getValueAt(i,140).toString()+"',"+
                    "retensi_rm='"+tbUser.getValueAt(i,141).toString()+"',"+
                    "temporary_presensi='"+tbUser.getValueAt(i,142).toString()+"',"+
                    "jurnal_harian='"+tbUser.getValueAt(i,143).toString()+"',"+
                    "sirkulasi_obat2='"+tbUser.getValueAt(i,144).toString()+"',"+
                    "edit_registrasi='"+tbUser.getValueAt(i,145).toString()+"',"+
                    "bpjs_referensi_diagnosa='"+tbUser.getValueAt(i,146).toString()+"',"+
                    "bpjs_referensi_poli='"+tbUser.getValueAt(i,147).toString()+"',"+
                    "industrifarmasi='"+tbUser.getValueAt(i,148).toString()+"',"+
                    "harian_js='"+tbUser.getValueAt(i,149).toString()+"',"+
                    "bulanan_js='"+tbUser.getValueAt(i,150).toString()+"',"+
                    "harian_paket_bhp='"+tbUser.getValueAt(i,151).toString()+"',"+
                    "bulanan_paket_bhp='"+tbUser.getValueAt(i,152).toString()+"',"+
                    "piutang_pasien2='"+tbUser.getValueAt(i,153).toString()+"',"+
                    "bpjs_referensi_faskes='"+tbUser.getValueAt(i,154).toString()+"',"+
                    "bpjs_sep='"+tbUser.getValueAt(i,155).toString()+"',"+
                    "suplier_penunjang='"+tbUser.getValueAt(i,156).toString()+"',"+
                    "bpjs_monitoring_klaim='"+tbUser.getValueAt(i,157).toString()+"',"+
                    "harian_kamar='"+tbUser.getValueAt(i,158).toString()+"',"+
                    "rincian_piutang_pasien='"+tbUser.getValueAt(i,159).toString()+"',"+
                    "keuntungan_beri_obat_nonpiutang='"+tbUser.getValueAt(i,160).toString()+"',"+
                    "hutang_obat='"+tbUser.getValueAt(i,161).toString()+"',"+
                    "riwayat_obat_alkes_bhp='"+tbUser.getValueAt(i,162).toString()+"',"+
                    "sensus_harian_poli='"+tbUser.getValueAt(i,163).toString()+"',"+
                    "aplicare_referensi_kamar='"+tbUser.getValueAt(i,164).toString()+"',"+
                    "aplicare_ketersediaan_kamar='"+tbUser.getValueAt(i,165).toString()+"',"+
                    "akun_piutang='"+tbUser.getValueAt(i,166).toString()+"',"+
                    "harian_kso='"+tbUser.getValueAt(i,167).toString()+"',"+
                    "bulanan_kso='"+tbUser.getValueAt(i,168).toString()+"',"+
                    "harian_menejemen='"+tbUser.getValueAt(i,169).toString()+"',"+
                    "bulanan_menejemen='"+tbUser.getValueAt(i,170).toString()+"'");
            }
            tampil();
            emptTeks();
        }
    ...
    private void tampil() {
        try{
            ...
            ps=koneksi.prepareStatement("select AES_DECRYPT(id_user,'nur'),AES_DECRYPT(password,'windi'),"+
                        ...
                        "deposit_pasien, piutang_pasien, barcode, presensi_harian, presensi_bulanan, "+
                        ...
                        "ipsrs_rekap_pengadaan, ipsrs_rekap_stok_keluar, ipsrs_pengeluaran_harian, informasi_kamar, harian_tindakan_poli, obat_per_poli, obat_per_kamar, "+
                        ...
                        "biaya_masuk_sekali, set_no_rm, billing_ralan, billing_ranap, jm_ranap_dokter, igd, "+
                        "set_harga_obat_ralan,set_harga_obat_ranap,diagnosa_pasien,kunjungan_ralan,harian_tindakan_dokter, "+
                        "sidikjari,jam_masuk,jadwal_pegawai,set_nota,dpjp_ranap,mutasi_barang,"+
                        ...
                        "harian_paket_bhp,bulanan_paket_bhp,piutang_pasien2,bpjs_referensi_faskes,bpjs_sep,"+
                        "suplier_penunjang,bpjs_monitoring_klaim,harian_kamar,rincian_piutang_pasien,keuntungan_beri_obat_nonpiutang,"+
                        "hutang_obat,riwayat_obat_alkes_bhp,sensus_harian_poli,aplicare_referensi_kamar, "+
                        "aplicare_ketersediaan_kamar,akun_piutang,harian_kso,bulanan_kso,harian_menejemen,bulanan_menejemen from user order by AES_DECRYPT(id_user,'nur')");
            try {
                rs=ps.executeQuery();
                while(rs.next()){
                    user="";
